...
<marquee  ONMOUSEOVER="this.stop();" ONMOUSEOUT="this.start();"  scrollamount="6"  bgcolor="white"  behavior="alternate">
	<H2> Virtual Class room </H2>
</marquee>
   ...
   <TD> 
	...
	<tr><td bgcolor="white" style="padding:5"><br> 
		...
		<tr><td colspan=2><font face="verdana,arial" size=-1>Lost your username or password? Find it <a href="G:\study\seminar\ppt\ppt_for_05].ppt">here</a>!</font></td></tr>
                <tr><td colspan=2><font face="verdana,arial" size=-1>Not member yet? Click <a href="studsignup.jsp">here</a>   to register.</font></td></tr>
...
if(str1!=null && str2!= null)
{
	...
	try{
		...
		String sql="select * from student where user='"+str1+"' and pass='"+str2+"'";
