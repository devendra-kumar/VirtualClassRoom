...
<form action="pptdeladmin.jsp"  method="post" >
...
<br>
<br>
<h4 align="center"><b>PPT Name   :  </b><input type="text" value="" name="ppt"> &emsp; &emsp; <input type="submit" value="DELETE"   >
<br>
</h4><br>
...
<tr>
 ...
 <%
	try{
		...
		String sql="select * from ppt ";
			ResultSet rs= s.executeQuery(sql);
%>
<tr><td><b>SUBJECT</b><td><b>PPT</b> 
<%			
			while( rs.next() )
			{
%>
...
<%					
		...
		if(ppt!=null)
		{	sql="delete from ppt where ppt='"+ppt+"'";
			s.execute(sql);
		}
