...
<td align="left" style="word-spacing:6px;font-size:120%;padding-right:30px;color:#888888;white-space:nowrap;">
    ...
    <a href="videosub1.jsp" title="<% out.println(temp); %>" class=" tablecontent menubar"><% out.println(temp); %> </a>  | 
<%	rs.next();
temp=rs.getString(1);
%>
<a href="videosub2.jsp" title="<% out.println(temp); %>" class=" tablecontent menubar"><% out.println(temp); %> </a>  | 
<%	rs.next();
temp=rs.getString(1);
%>
<a href="videosub3.jsp" title="<% out.println(temp); %>" class=" tablecontent menubar"><% out.println(temp); %> </a>  | 
<%	rs.next(); 
temp=rs.getString(1);
%>
<a href="videosub4.jsp" title="<% out.println(temp); %>" class=" tablecontent menubar"><% out.println(temp); %> </a>  | 
<%	rs.next(); 
temp=rs.getString(1);
%>
<a href="videosub5.jsp" title="<% out.println(temp); %>" class=" tablecontent menubar"><% out.println(temp); %> </a>  | 
<%rs.close(); %>
