...
<body bgcolor="#FFFF99" > 
<form  action="videouploadupdateadmin.jsp" method="post" >
...
<center><table>
        ...
        <tr><td align="center">  <font face="verdana,arial" size=-1>   Select Video :</font></td>  <td>   <input type="file" name="file1">  </td>  </tr>
